...
var Emberbase=function(e){var t=e.split("/").slice(0,3).join("/"),s=e.split("/").slice(3,4).join("/");this.socket=io.connect(t+"/"+s),this._is_server_ready=!1;var r=this;return this.socket.on("SRV_NOT_RDY_ERR",function(){throw new Error("The server is not ready to accept data")}),this.socket.on("SRV_RDY_MSG",function(){r._is_server_ready=!0}),this};Emberbase.prototype.set=function(e){if(!this._is_server_ready)throw new Error("The server is not ready to accept data");return this.socket.emit("set_event",e),this},Emberbase.prototype.push=function(e){if(!this._is_server_ready)throw new Error("The server is not ready to accept data");return this.socket.emit("push_event",e),this},Emberbase.prototype.on=function(e,t){switch(e){case"value":this.socket.emit("CLT_VAL_EVT_MSG");break;case"child_added":this.socket.emit("CLT_CHLD_ADD_EVT_MSG")}return this.socket.on(e+"_event",t),this};