...
var Emberbase=function(t,e,o){var s=t.split("/").slice(0,3).join("/"),i=t.split("/").slice(3,4).join("/");this._socket=io.connect(s),e&&o?this._socket.emit("JOIN_ROUTE_MSG",{route:i,auth:{user:e,pass:o}}):this._socket.emit("JOIN_ROUTE_MSG",{route:i}),this._routeReady=!1;return this._socket.on("SERVER_NOT_READY_ERR",function(){throw new Error("The server is not ready to accept data")}),this._socket.on("ROUTE_ERR",function(){throw new Error("The route "+i+" does not exist on the server")}),this._socket.on("AUTH_ACK",function(){console.log("Client authenticated")}),this._socket.on("AUTH_ERR",function(){throw new Error("Authentication error")}),this};Emberbase.prototype.set=function(t){return this._socket.emit("set_event",t),this},Emberbase.prototype.push=function(t){return this._socket.emit("push_event",t),this},Emberbase.prototype.on=function(t,e){switch(t){case"value":this._socket.emit("CLIENT_VALUE");break;case"child_added":this._socket.emit("CLIENT_CHILD_ADDED")}return this._socket.on(t+"_event",e),this};