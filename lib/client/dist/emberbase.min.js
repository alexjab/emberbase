...
var Emberbase=function(t,e,i){var s=t.split("/").slice(0,3).join("/"),o=t.split("/").slice(3,4).join("/");return this._socket=io.connect(s),e&&i?this._socket.emit("JOIN_ROUTE_MSG",{route:o,auth:{user:e,pass:i}}):this._socket.emit("JOIN_ROUTE_MSG",{route:o}),this._client_value=!1,this._client_child_added=!1,this._socket.on("reconnect",function(){e&&i?this._socket.emit("JOIN_ROUTE_MSG",{route:o,auth:{user:e,pass:i}}):this._socket.emit("JOIN_ROUTE_MSG",{route:o}),this._socket.on("JOIN_ROUTE_ACK",function(){this._client_value&&this._socket.emit("CLIENT_VALUE"),this._client_child_added&&this._socket.emit("CLIENT_CHILD_ADDED")}.bind(this))}.bind(this)),this._routeReady=!1,this._socket.on("SERVER_NOT_READY_ERR",function(){throw new Error("The server is not ready to accept data")}),this._socket.on("UNKNOWN_ROUTE_ERR",function(){throw new Error("The route "+o+" does not exist on the server")}),this._socket.on("JOIN_ROUTE_ERR",function(){throw new Error("An error happened while trying to join a route. If this is not the first time you are seeing this message, please reload the page.")}),this._socket.on("AUTH_ACK",function(){console.log("Client authenticated")}),this._socket.on("AUTH_ERR",function(){throw new Error("Authentication error")}),this};Emberbase.prototype.set=function(t,e){return e?this._socket.emit("set_event",{path:t,data:e}):this._socket.emit("set_event",{data:t}),this},Emberbase.prototype.push=function(t,e){return e?this._socket.emit("push_event",{path:t,data:e}):this._socket.emit("push_event",{data:t}),this},Emberbase.prototype.on=function(t,e){switch(t){case"value":this._client_value=!0,this._socket.emit("CLIENT_VALUE");break;case"child_added":this._client_child_added=!0,this._socket.emit("CLIENT_CHILD_ADDED")}return this._socket.on(t+"_event",e),this};