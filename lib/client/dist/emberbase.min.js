...
var Reference=function(t,e,i){return this._socket=t,this._route=e,this.path=i,this};Reference.prototype.set=function(t){return this._socket.emit("set_event",{path:this.path,data:t,_route:this._route}),this},Reference.prototype.push=function(t){return this._socket.emit("push_event",{path:this.path,data:t,_route:this._route}),this},Reference.prototype.on=function(t,e){if("value"===t){this._client_value=!0,this._socket.emit("CLIENT_VALUE",{_route:this._route});var i=function(t,e,i){var o=function(t,e){var s=t.shift();t.length?o(t,e[s]):e[s]&&i(e[s])};o(t.split("/"),e)};this._socket.on("value_event",function(t){""===this.path?e(t):t.path!==this.path?i(this.path,t.val,function(i){t.val=i,e(t)}):e(t)}.bind(this))}else"child_added"===t&&(this._client_child_added=!0,this._socket.emit("CLIENT_CHILD_ADDED",{_route:this._route}),this._socket.on("child_added_event",function(t){t.path===this.path&&e(t)}.bind(this)));return this},Reference.prototype.child=function(t){return new Reference(this._socket,this._route,t)};var Emberbase=function(t,e,i){var o=t.split("/").slice(0,3).join("/"),s=t.split("/").slice(3,4).join("/");this._socket=io.connect(o),e&&i?this._socket.emit("JOIN_ROUTE_MSG",{route:s,auth:{user:e,pass:i}}):this._socket.emit("JOIN_ROUTE_MSG",{route:s}),this._client_value=!1,this._client_child_added=!1,this._socket.on("reconnect",function(){e&&i?this._socket.emit("JOIN_ROUTE_MSG",{route:s,auth:{user:e,pass:i}}):this._socket.emit("JOIN_ROUTE_MSG",{route:s}),this._socket.on("JOIN_ROUTE_ACK",function(){this._client_value&&this._socket.emit("CLIENT_VALUE",{_route:s}),this._client_child_added&&this._socket.emit("CLIENT_CHILD_ADDED",{_route:s})}.bind(this))}.bind(this)),this._routeReady=!1,this._socket.on("SERVER_NOT_READY_ERR",function(){throw new Error("The server is not ready to accept data")}),this._socket.on("UNKNOWN_ROUTE_ERR",function(t){throw new Error("The route "+t.route+" does not exist on the server")}),this._socket.on("AUTH_ACK",function(){console.log("Client authenticated")}),this._socket.on("AUTH_ERR",function(){throw new Error("Authentication error")});var n=new Reference(this._socket,s,"");return n};