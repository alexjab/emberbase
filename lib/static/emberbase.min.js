...
var Emberbase=function(e){var t=e.split("/").slice(0,3).join("/"),s=e.split("/").slice(3,4).join("/");return this.socket=io.connect(t+"/socket/"+s),this};Emberbase.prototype.set=function(e){return this.socket.emit("set_event",e),this},Emberbase.prototype.push=function(e){return this.socket.emit("push_event",e),this},Emberbase.prototype.on=function(e,t){return"value"===e&&this.socket.on("value_event",t),"child_added"===e&&this.socket.on("child_added_event",t),this};